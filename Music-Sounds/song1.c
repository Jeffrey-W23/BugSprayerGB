...
static const unsigned char* const order1[] = {P0,P4,P8,P24,P0};
static const unsigned char* const order2[] = {P1,P5,P9,P25,P0};
static const unsigned char* const order3[] = {P2,P6,P10,P26,P0};
static const unsigned char* const order4[] = {P3,P7,P11,P15,P23};
...
const hUGESong_t m_sSong1 = {7, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
